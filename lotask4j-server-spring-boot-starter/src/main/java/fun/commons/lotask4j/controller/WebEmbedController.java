...
public class WebEmbedController {
    ...
    @Value("${lotask4j.web-embed.front-base-url:/web-embed/index.html}")
    private String frontBaseUrl;

    @Value("${lotask4j.web-embed.cookie-expire-seconds:7200}")
    ...
    @Value("${lotask4j.web-embed.open-default-user-id:guest}")
