<template>
  <div class="app-page">
    <TitledSection :title="t('clientGuide.title')" icon="ri-user-line">
      <WorkSection>
        <el-tabs v-model="activeTab" class="guide-tabs">
          <el-tab-pane :label="`📚 ${t('clientGuideExt.tabs.overview')}`" name="overview">
            <div class="markdown-body" v-html="overviewHtml" />
          </el-tab-pane>
          <el-tab-pane :label="`📡 ${t('clientGuideExt.tabs.api')}`" name="api">
            <div class="markdown-body" v-html="apiHtml" />
          </el-tab-pane>
          <el-tab-pane :label="`💻 ${t('clientGuideExt.tabs.code')}`" name="code">
            <div class="markdown-body" v-html="codeHtml" />
          </el-tab-pane>
          <el-tab-pane :label="`⭐ ${t('clientGuideExt.tabs.bestPractices')}`" name="bestPractices">
...
// Raw markdown imports — Vite resolves these as strings
import overviewMd from '@/content/client-guide/overview.md?raw'
import apiListMd from '@/content/client-guide/api-list.md?raw'
import codeExamplesMd from '@/content/client-guide/code-examples.md?raw'
import bestPracticesMd from '@/content/client-guide/best-practices.md?raw'
...
const codeHtml = computed(() => renderMarkdown(codeExamplesMd))
