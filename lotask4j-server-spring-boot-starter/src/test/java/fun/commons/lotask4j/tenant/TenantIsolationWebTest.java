...
import fun.commons.lotask4j.AstsServerTestApplication;
 ...
 */
@SpringBootTest(classes = AstsServerTestApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
